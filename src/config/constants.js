...
export const GET_WO_PARAMS = '&filter[plannedDate][gte]=2020-11-01&filter[plannedDate][lte]=2020-12-31&' +
    ...
    'longDescription,businessUnit,projectYear,projectName,customerName,projectColor,externalProjectNo,projectYear,resourcesNonHr,totalBookedHours,plannedWorkTime';
